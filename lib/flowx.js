...
export default class Flowx {
  ...
  zoom(x) {
    ...
    this.blocks.forEach((b) => {
      b.el.style.width = `${size.nodeWidth}px`
      b.el.style.height = `${size.nodeHeight}px`
  ...
  */
  ...
  async renderBlock(block) {
    ...
    $container.style.width = size.nodeWidth + "px"
    $container.style.height = size.nodeHeight + "px"
